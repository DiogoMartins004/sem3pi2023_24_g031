...
DECLARE
    production_factors SYS.ODCIVARCHAR2LIST := SYS.ODCIVARCHAR2LIST('Calda Bordalesa ASCENZA', 'Enxofre Bayer 80 WG', 'Patentkali');
    manufacturers SYS.ODCIVARCHAR2LIST := SYS.ODCIVARCHAR2LIST('ASCENZA', 'Bayer', 'K+S');
    quantities SYS.ODCINUMBERLIST := SYS.ODCINUMBERLIST(10, 20, 30);
    units SYS.ODCIVARCHAR2LIST := SYS.ODCIVARCHAR2LIST('kg', 'kg', 'kg');
    recipe_name VARCHAR(255) := 'Fertirega 1';
    message VARCHAR(255);
